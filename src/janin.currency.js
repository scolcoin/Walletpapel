...
janin.currency = {
    ...
    useCurrency: function(index) {
        ...
        {
            janin.doge = new Doge(['Scolcoin', 'so paper wallet', 'such random', 'very pretty', 'much design', 'awesome', 'much crypto', 'such coin', 'wow!!', 'to da moon']);
            return;
        }
...
janin.currencies = [
    ...
    janin.currency.createCurrency ("Scolcoin",             0x40, 0xbf, "7",    "V" , "Srsz4KEyRCqfAcNQ9rW7jz52aaSoN7qpfz"),
	janin.currency.createCurrency ("Testnet Bitcoin",     0x6f, 0xef, "9",    "c"    , ""),
                   ];
